...
import { Search, RotateCcw, Sword, Star, ChevronDown, ChevronUp, BookOpen, ExternalLink, Save, Plus, Trash2, Edit3, CheckSquare } from "lucide-react";
...
export default function App() {
  ...
  const counterRecs = useMemo(() => recommendAllCounters(enemyChamp, userData), [enemyChamp, userData]);
