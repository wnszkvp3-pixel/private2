...
function SelectModal({title, champions, selected, blocked, onSelect, onClose, multi=false, currentPool=[]}){
  ...
  return <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/70 p-3 sm:items-center">
    <div className="max-h-[88vh] w-full max-w-4xl overflow-hidden rounded-3xl border border-slate-700 bg-slate-950">
